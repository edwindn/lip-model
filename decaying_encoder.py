...
OUTPUT_DIM = 5
DATA_FOLDER = 'data'
INFER_FOLDER = 'data_infer'
SAVE_WEIGHTS = 'encoder_weights.pth'
INFER_WEIGHTS = 'encoder_weights_B.pth'
# ---

WEIGHTS = [0.75, 0.5, 0.25, 0.1] # how much weight we give to previous expressions
...
def train(model, train_loader, test_loader):
    ...
    scheduler = StepLR(optimizer, step_size=200, gamma=GAMMA)  # Define the scheduler
...
def main_train():
    train_loader, test_loader = get_dataloader(DATA_FOLDER, batch_size=BATCH_SIZE) # for sequential data manually batch the inputs
